...
class FitOpt_Dialog(ModelessDialog):
	...
	# Name of temporal chimera.bin file
	chimera_bin_f = "chimera.bin"
    ...
    def Fit(self):
		...
		# Set the file name that will be generated by FitOpt with all the solutions parameters:
		# center of mass, Euler Angles and traslations of the PDB solutions
		self.filename_chimera = cwd + self.chimera_bin_f
	...
	def read_solutions_chimera(self):
		...
		import os
		# Get the file size
		f = open(self.chimera_bin_f, "rb")
		size = get_size_chimera_bin(f)
		n = (size / 4);

		# Data: Cx, Cy, Cz, 3 Ruler Angles (ZXZ convention), Traslation(xyz)
